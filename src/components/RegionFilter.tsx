...
export const RegionFilter = (): JSX.Element => {
  ...
  return (
    <div className='w-1/2 max-w-[200px]' aria-haspopup={true}>
      <div className='relative'>
        <button
          className='w-full text-sm text-left pl-5 rounded-md py-3 bg-dark-mode-element text-dark-mode-text shadow-md'
      ...
      <ul
        className={`flex w-1/2 max-w-[200px] bg-dark-mode-element shadow-lg rounded-md flex-col gap-2 mt-3 py-2 z-10 ${
